    ...
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-toolbar">
        ...
        >
          ...
          <!--begin::Add item-->
          <router-link :to="{ name: 'study-programs-create' }" class="btn btn-primary">
...
export default defineComponent({
  ...
  setup() {
    ...
    const deleteitems = async (id) => {
      ...
      await ApiService.delete(`/study-programs/${id}`);
    };
    ...
    const exportItems = async () => {
      const response = await ApiService.post(`/study-programs`, {});
